...
[View on GitHub](https://github.com/megamsys/cache-kit.rs)
...
**Note:** cache-kit is async-first and designed for modern async databases (SQLx, SeaORM, tokio-postgres). See the [Async Programming Model](/concepts/async-model) page for details.
...
See the [Serialization Support](/concepts/serialization) page for detailed guidance.
...
See the [Cache Backend Support](/integration/backends) page for configuration details.
...
- Learn the [core concepts](/concepts/concepts) behind cache-kit
- Understand [async usage patterns](/concepts/async-model)
- Explore [ORM and backend compatibility](/integration/database-compatibility)
